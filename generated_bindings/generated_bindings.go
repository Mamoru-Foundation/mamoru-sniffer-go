...
// EvmBlockchainDataBuilderSetStatistic function as declared in include/libmamoru_sniffer_go.h:98
func EvmBlockchainDataBuilderSetStatistic(Builder *FfiEvmBlockchainDataBuilderT, Blocks uint64, Transactions uint64, Events uint64, CallTraces uint64) {
	cBuilder, cBuilderAllocMap := (*C.FfiEvmBlockchainDataBuilder_t)(unsafe.Pointer(Builder)), cgoAllocsUnknown
	...
	C.evm_blockchain_data_builder_set_statistic(cBuilder, cBlocks, cTransactions, cEvents, cCallTraces)
